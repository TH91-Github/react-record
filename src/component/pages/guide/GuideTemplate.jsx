...
import { fonts, colors } from "component/styled/common/Variable";
          ...
          <div className="guide__cont">
            <div className="guide__info">
              ...
              <div className="guide__info__desc">
                ...
                <p className="desc">Styled Var: component/styled/common/Variable.jsx</p>
                <p className="desc">⚠️ SCSS, Styled var 둘 다 수정.</p>
                <p className="desc">✅ 사용법 EX) : SCSS - <S.colorTag $color={colors.color4}>$fontB;</S.colorTag> / <S.colorTag $color={colors.color4}>Styled - fonts.fontB</S.colorTag></p>
              </div>
            </div>
            <div className="font">
          ...
          <div className="guide__cont">
            <div className="guide__info">
              ...
              <div className="guide__info__desc">
                ...
                <p className="desc">Styled Var: component/styled/common/Variable.jsx</p>
                <p className="desc">⚠️ SCSS, Styled var 둘 다 수정.</p>
                <p className="desc">✅ 사용법 EX) : SCSS - <S.colorTag $color={colors.color4}>$whiteColor;</S.colorTag> / <S.colorTag $color={colors.color4}>Styled - colors.whiteColor</S.colorTag></p>
              </div>
            </div>
            <div className="color">

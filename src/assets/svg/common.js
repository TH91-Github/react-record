...
// magnifying-glass, 검색
export const SvgSearch = React.memo(({fill='#000'}) => (
...
// code-bracket, 코드
export const SvgCode = React.memo(({fill='#000'}) => (
...
// cube-transparent 큐브
export const SvgCube = React.memo(({fill='#000'}) => (
  <svg viewBox="0 0 24 24" fill={fill}>
...
// setting 설정
export const SvgSetting = React.memo(({fill='#000'}) => (

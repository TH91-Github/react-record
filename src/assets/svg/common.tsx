...
// magnifying-glass, 검색
export const SvgSearch = React.memo(({fill='#000'}:SvgType) => (
...
// code-bracket, 코드
export const SvgCode = React.memo(({fill='#000'}:SvgType) => (
...
// cube-transparent 큐브
export const SvgCube = React.memo(({fill='#000'}:SvgType) => (
  <svg viewBox="0 0 24 24" fill={fill}>
...
// book 
export const SvgBook = React.memo(({fill='#000'}:SvgType) => (
...
export const SvgClipboard = React.memo(({fill='#000'}:SvgType) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// 폴더
export const SvgFolder = React.memo(({fill='#000'}:SvgType) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// 컴포넌트
export const SvgComponent = React.memo(({fill='#000'}:SvgType) => (
  <svg viewBox="0 0 24 24" fill={fill}>
...
export const SvgSquareStack = React.memo(({fill='#000'}:SvgType) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// 퍼즐
export const SvgPuzzle = React.memo(({fill='#000'}:SvgType) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// setting 설정
export const SvgSetting = React.memo(({fill='#000'}:SvgType) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>

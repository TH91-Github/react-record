...
// magnifying-glass, 검색
export const SvgSearch = React.memo(({fill='#000'}:SvgPropsType) => (
...
// code-bracket, 코드
export const SvgCode = React.memo(({fill='#000'}:SvgPropsType) => (
...
// book 
export const SvgBook = React.memo(({fill='#000'}:SvgPropsType) => (
...
export const SvgClipboard = React.memo(({fill='#000'}:SvgPropsType) => (
  <StyledSvg className="i-stroke" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// 폴더
export const SvgFolder = React.memo(({fill='#000'}:SvgPropsType) => (
  <StyledSvg className="i-stroke" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// 컴포넌트
export const SvgComponent = React.memo(({fill='#000'}:SvgPropsType) => (
  <StyledSvg className="i-fill" viewBox="0 0 24 24" fill={fill}>
...
export const SvgSquareStack = React.memo(({fill='#000'}:SvgPropsType) => (
  <StyledSvg className="i-stroke" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// 퍼즐
export const SvgPuzzle = React.memo(({fill='#000'}:SvgPropsType) => (
  <StyledSvg className="i-stroke" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// setting 설정
export const SvgSetting = React.memo(({fill='#000'}:SvgPropsType) => (
  <StyledSvg className="i-stroke" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// 디자인 붓 paint-brush
export const SvgDesign = React.memo(({fill='#000'}:SvgPropsType) => (
  <StyledSvg className="i-stroke" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
export const SvgRectangleStack = React.memo(({fill='#000'}:SvgPropsType) => (
  <StyledSvg className="i-stroke" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={fill}>
...
// // book 책 open
// <StyledSvg className="i-svg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
//   <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
// </StyledSvg>

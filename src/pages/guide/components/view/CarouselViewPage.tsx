...
export const CarouselViewPage = () => {
  const demoData: CarouselDemoType[] = [
    ...
    {
      tit:'case-2',
      desc:'옵션 - x : 리스트 총 2개부터 carousel 동작',
      lists:['case2', 'case2', 'case2', 'case2'],
    },
    {
      tit:'case-3',
      desc:`옵션 - <span className="highlight">slidesPerView</span>: 4, <span className="highlight">loop</span>:true, <span className="highlight">autoplay</span>:{delay: 2000}`,
    ...
    {
      tit:'case-4',
      desc:'<span className="highlight">slidesPerView</span>: 1, <span className="highlight">pagination</span>: true,',
    ...
    {
      tit:'case-5',
      desc:`<span className="highlight">slidesPerView</span>: 1, <span className="highlight">pagination</span>:{clickable:true, type:'progressbar'}, <span className="highlight">navigation</span>: true,`,
        ...
        <div className="example-lists">
          {
            demoData.map((item, idx) => (
              <div className={`example-item item-${idx}`} key={idx}>
                <p className="s-tit">{item.tit}</p>
                <InnerHTML tag="p" data={item.desc} customClass={'desc'} />
